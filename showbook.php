<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST" && $_POST['search']){
        ...
        $array=$books->get_all_coloumn($keyword, $genre, $format, $string_group);   
    }
...
<body>
    ...
    <h2>Books Table</h2>
        ...
        <form action="" method="POST">
            ...
            <br><br><div class="flex"><label for="agegroup">Age Group</label></div><br>
                    ...
                    <input type="checkbox" name="agegroup[]" value="Adults" id="Adults" <?= (in_array("Adults",$age_group))? "checked" : "" ?>>           
            ...
            <?php
             ...
             ?>       
                ...
                <tr class="<?= $bg ?>">
                    ...
                    <td>
                        <a href="edit.php?id=<?= $arr['book_id']?>" class="edit">edit</a><br>
                        <a data-id="<?= $arr['book_id']?>" data-title="<?= $arr['book_title']?>" class="del">delete</a>
                    </td>
